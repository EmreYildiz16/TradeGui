...
class TradeGui{
	...
	public function openTrade(){
        ...
        $this->menu->getInventory()->setItem(45,Item::get(236,14,1)->setCustomName("§aKabul Et"));
        $this->menu->getInventory()->setItem(53,Item::get(236,14,1)->setCustomName("§aKabul Et"));
	...
	public function inventoryEvent(Player $player, Item $item, Item $width, SlotChangeAction $action):bool{
        if($action->getSlot() == 45 && $player->getName() == $this->sender->getName()){
            if($item->getDamage() == 14){
                $this->menu->getInventory()->setItem(45,Item::get(236,5,1)->setCustomName("§cİptal Et"));
        ...
        elseif($action->getSlot() == 53 && $player->getName() == $this->player->getName()){
            if($item->getDamage() == 14){
                $this->menu->getInventory()->setItem(53,Item::get(236,5,1)->setCustomName("§cİptal Et"));
	...
	public function successfulTrade(){
        ...
        foreach($items as $index => $item){
            ...
            $this->sender->sendMessage("§aTakas Başarılı!");
            $this->player->sendMessage("§aTakas Başarılı!");
            $this->finish = 0;
